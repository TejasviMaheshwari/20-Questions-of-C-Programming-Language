#include<stdio.h>
/*WAP to input television price from user and calculate net television amount:
If television is Colored & 24” discount = 10% or 32” discount = 15%.
If television is B & W & 21” discount = 12%.  */
void main()
{
    float tp , ntp , dis ;
    char c;
